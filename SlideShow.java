...
public class SlideShow extends JFrame {
	...
	private void initComponent() {
		...
		textPane = new JPanel();
		textPane.setBackground(Color.WHITE);// changes background from blue to white
	...
	// changes images to the appropriate detox/ wellness destination the snhu travel is focusing on
